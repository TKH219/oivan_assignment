...
// in oivan_assignment/test/controller_test/get_list_sof_users_test.dart.
...
import 'package:oivan_assignment/data/entities/entity.dart' as _i8;
...
/// A class which mocks [GetListSofUsersResponse].
///
/// See the documentation for Mockito's code generation for more information.
class MockGetListSofUsersResponse extends _i1.Mock
    implements _i6.GetListSofUsersResponse {
  MockGetListSofUsersResponse() {
    _i1.throwOnMissingStub(this);
  }

  @override
  List<_i8.SofUserEntity> get items => (super.noSuchMethod(
        Invocation.getter(#items),
        returnValue: <_i8.SofUserEntity>[],
      ) as List<_i8.SofUserEntity>);
  @override
  set items(List<_i8.SofUserEntity>? _items) => super.noSuchMethod(
        Invocation.setter(
          #items,
          _items,
        ),
